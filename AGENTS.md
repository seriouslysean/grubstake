...
28. Keep agent-session links and session trailers out of commit messages, issues, and pull request bodies, because they point outside this repository and the leak scan refuses that shape.
