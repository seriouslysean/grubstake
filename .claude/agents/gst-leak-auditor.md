...
- Test results quoted in a body: confirm they cite an executed run at a named revision, and report any that do not as unverified. Never rerun the suite to check them.
